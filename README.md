...
Applying Python visualization libraries

Translating business questions into data insights

🙌 Acknowledgements
This project was completed as part of a data analytics learning program.
Dataset source: Online Retail Dataset (UCI Machine Learning Repository).
